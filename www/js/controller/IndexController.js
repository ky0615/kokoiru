angular.module("application").controller("IndexController", ["$rootScope", "$scope", "$http", "$interval", "$timeout", "$mdSidenav", "$mdDialog", "$mdToast", "socketio", function($rootScope, $scope, $http, $interval, $timeout, $mdSidenav, $mdDialog, $mdToast, socketio) {
  var originatorEv;
  $scope.users = [];
  originatorEv = void 0;
  $scope.boadingRate = {
